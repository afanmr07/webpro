...
<div class=" container p-3 bg-secondary text-white">
                <form class="row justify-content-center" method="post" action="<?= site_url('c_daftar/daftarUser')?>">
                    ...
                    <div class="float-end mb-5">
                        <a class="btn btn-danger" id="back" href="<?php echo site_url('c_home/login') ?>">Batalkan</a>
