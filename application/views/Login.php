...
<body>
    ...
    <div class="container">
        <form class="form" action="<?php echo site_url('c_login/login') ?>">
            ...
            <p class="form__text">
                <a class="form__link" href="<?php echo site_url('c_daftar/index') ?>" id="linkCreateAccount">Don't have an account? Create account</a>
            </p>
        </form>
